...
/*
 * 
 * CODIGO DESCONSIDERANDO UM OU MAIS NUMEROS EM QUANTIDADE DE LANCAMENTOS ALTOS
 * 
 * SAIU DE 3 - 4% PARA 10%
 * 
 */
...
public class App2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            int qtdLancamentos = cont1 + cont2 + cont3 + cont4 + cont5; // AQUI EXCLUI O NUMERO 6 DA CONTAGEM (cont6)
            ...
            if (opcao != 0) {
                ...
                switch (resultado) {
                    ...
                    //     cont6++;  
                    //     break;
                    // EXCLUINOD O 6 DO ENQCREMENTO TBM
                    default:
                        break;
                }
